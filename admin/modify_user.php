            ...
            <div class="templatemo-content-container">
                <div class="templatemo-content-container">
                    <div class="templatemo-content-widget white-bg">
                        ...
                        <p> </p>
                        <hr>
                        <form action="./dispose/modify_user_dispose.php" class="templatemo-login-form" method="post">
                            ...
                            <div class="row form-group">
                                <div class="col-lg-6 col-md-6 form-group">
                                    <label>电话</label>
                                    <input type="text" class="form-control" value="<?php echo $rows[0]['tel'] ?>" name="tel">
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                <div class="col-lg-6 col-md-6 form-group">
                                    <label>生日</label>
                                    <input type="date" class="form-control"  value="<?php echo $rows[0]['birthday'] ?>" name="birthday">
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                    ...
                                    <div class="col-lg-12 form-group">
                                        <div class="templatemo-inline-block">
                                            <input style="display: inline-block;" type="radio" name="sex" id="r4" value="男"<?php echo $rows[0]['sex']=='男'?'checked':''  ?> >
                                            <label style="width:1.2em;" for="r4" class="font-weight-300"><span></span>男</label>
                                        </div>
                                        <div class=" templatemo-inline-block">
                                            <input style="display: inline-block;" type="radio" name="sex" id="r5" value="女"<?php echo $rows[0]['sex']=='女'?'checked':''  ?> >
                                            <label style="width:1.2em;" for="r5" class="font-weight-300"><span></span>女</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
