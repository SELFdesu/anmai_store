<?php
    ...
    $sql="select count(orderid) from product_order where userid={$userid} and whether_comment='0' and signfor='1'";
    ...
    $sql="SELECT tb2.id,tb2.productname,tb2.photo,tb2.price,tb1.num,tb1.allprice,tb1.orderid,tb1.time FROM product_order tb1 INNER JOIN product_show tb2 ON tb1.productid=tb2.id and tb1.userid={$userid} and tb1.whether_comment='0' and tb1.signfor='1' ORDER BY tb1.orderid DESC LIMIT {$star_num},{$onePageNum};";
    $result=mysqli_query($link,$sql);
                        ...
                        <?php for($i=0;$i<count($rows);$i++){?>
                            <div class="myorder_content_row">
                                <form action="" method="post">
                                    ...
                                    <div class="content_row_allprice"><span><button type="submit" formaction="evaluatesub.php">去评价</button></span></div>
